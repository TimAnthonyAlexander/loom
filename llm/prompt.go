...
Do NOT hallucinate or write a commands output yourself in the same message as you write the command. 
The output will ALWAYS be generated by the system and appear in a message AFTER your command.
You are NOT ❌ allowed to write a command and then immediately TASK_RESULT and so on... That is not how it works.
Instead, write the command, wait for the output, then continue. 
